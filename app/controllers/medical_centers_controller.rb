  ...
  def create
    ...
    respond_to do |format|
      if @medical_center.save
        format.html { redirect_to medical_center_url(@medical_center), notice: "Medical center was successfully created." }
  ...
  def update
    respond_to do |format|
      if @medical_center.update(medical_center_params)
        format.html { redirect_to medical_center_url(@medical_center), notice: "Medical center was successfully updated." }
