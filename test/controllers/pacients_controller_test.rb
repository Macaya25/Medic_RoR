...
class PacientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pacient" do
    assert_difference("Pacient.count") do
      post pacients_url, params: { pacient: { address: @pacient.address, inf: @pacient.inf, last_name: @pacient.last_name, mail: @pacient.mail, name: @pacient.name, telephone: @pacient.telephone } }
    end
  ...
  test "should update pacient" do
    patch pacient_url(@pacient), params: { pacient: { address: @pacient.address, inf: @pacient.inf, last_name: @pacient.last_name, mail: @pacient.mail, name: @pacient.name, telephone: @pacient.telephone } }
